...
namespace PatientPortal.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatientId,Title,FirstName,MiddleName,LastName,Suffix,Dob,Ssn,Active,Street,Apartment,City,State,Zip,PrimaryInsurance,PrimaryInsuranceID,PrimaryInsuranceHolder,SecondaryInsurance,SecondaryInsuranceID,SecondaryInsuranceHolder,CreatedBy,Created,ModifiedBy,Modified")] Patient patient)
        {
